<%--<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DonorForm.aspx.cs" Inherits="BloodDonorManagement.BloodDonorManagement.DonorForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <div class="col-12">
        <h4 class="display-6" style="background-color:indigo; color:white; text-align:center; border:outset;" >Donor Registration</h4>
        
            <div class="form-group row mb-1">
                        <label class="col-form-label col-form-label-sm col-2">Blood Group</label>
                        <div class="col-6">
                            <asp:TextBox ValidationGroup="fv-in" CssClass="form-control form-control-sm" ID="BloodGroupTextBox" runat="server" />
                            <asp:RequiredFieldValidator ValidationGroup="fv-in" CssClass="text-danger err" ID="RequiredFieldValidator9" ControlToValidate="BloodGroupTextBox"  runat="server" ErrorMessage="Branch name is required"></asp:RequiredFieldValidator>
                        </div>
                    </div>
