<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Hospitals.aspx.cs" Inherits="BloodDonorManagement.BloodDonorManagement.Hospitals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
     <div class="row">
        <div class="col-12">
            <h2 class="display-6" style="background-color:teal; color: white; text-align: center; border: outset;">Hospitals (OBJ Data)</h2>
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="HospitalID" DataSourceID="odsHospitals" InsertItemPosition="LastItem">
            ...
            <asp:SqlDataSource ID="dsHospitals" runat="server" ConnectionString="<%$ ConnectionStrings:db %>" DeleteCommand="DELETE FROM [Hospitals] WHERE [HospitalID] = @HospitalID" InsertCommand="INSERT INTO [Hospitals] ([HospitalName], [Address], [Location]) VALUES (@HospitalName, @Address, @Location)" SelectCommand="SELECT * FROM [Hospitals]" UpdateCommand="UPDATE [Hospitals] SET [HospitalName] = @HospitalName, [Address] = @Address, [Location] = @Location WHERE [HospitalID] = @HospitalID">
                <DeleteParameters>
            ...
            <asp:ObjectDataSource ID="odsHospitals" runat="server" DataObjectTypeName="BloodDonorManagement.BloodDonorManagementBLL.HospitalDTO" DeleteMethod="Delete" InsertMethod="Insert" SelectCountMethod="HospitalCount" SelectMethod="GetAll" TypeName="BloodDonorManagement.BloodDonorManagementBLL.HospitalRepo" UpdateMethod="Update"></asp:ObjectDataSource>
        </div>
    </div>
</asp:Content>
