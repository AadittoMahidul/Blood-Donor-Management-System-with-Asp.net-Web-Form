<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ObjBlood.aspx.cs" Inherits="BloodDonorManagement.BloodDonorManagement.ObjBlood" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <div class="row px-2">
        <div class="col-12 border-bottom mb-3">
            <h2 class="display-6" style="background-color:teal; color:white; text-align:center; border:outset;">Blood (OBJ Data)</h2>
            
        </div>
        <div class="col-6 border-end">
            <h3 class="display-6" style="background-color:darkgray; color:white; text-align:center; border:outset;">Edit/Delete</h3>
            <asp:GridView CssClass="table table-bordered table-striped" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="BloodID" DataSourceID="odsBlood">
            ...
            <asp:ObjectDataSource ID="odsBlood" runat="server" DataObjectTypeName="BloodDonorManagement.BloodDonorManagementBLL.BloodDtO" DeleteMethod="Delete" InsertMethod="Insert" SelectCountMethod="BloodCount" SelectMethod="GetAll" TypeName="BloodDonorManagement.BloodDonorManagementBLL.BloodRepository" UpdateMethod="Update"></asp:ObjectDataSource>
        </div>
        <div class="col-6">
            <h4 class="display-6" style="background-color:darkgray; color:white; text-align:center; border:outset;" >Add New</h4>
            <asp:FormView Width="100%" ID="FormView1" DefaultMode="Insert" runat="server" DataKeyNames="BloodID" DataSourceID="odsBlood">
