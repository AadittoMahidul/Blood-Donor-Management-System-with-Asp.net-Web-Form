...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    <div class="row">
       <div class="col-12">
           ...
           <div class="form-group row mb-1">
               <div class="col-12">You have not registered, please register first<a href="register.aspx?ReturnUrl=<%: ReturnUrl %>">Register here</a><br />
                   <%--<asp:RangeValidator ID="RangeValidator1" ControlToValidate="RangeValidator1" runat="server" BackColor="Red" ErrorMessage="RangeValidator"></asp:RangeValidator>--%>
               </div>
